...
sed -i.mybak "s/\([\/\"]\)(nvogel)/$GITHUB_USER/g; s/typescript-npm-package-template\|my-package-name/$REPO_NAME/g; s/Nicolas Vogel/$FULL_NAME/g" package.json package-lock.json README.md
rm *.mybak
```
